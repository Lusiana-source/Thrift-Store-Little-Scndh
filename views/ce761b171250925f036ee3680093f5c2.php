    ...
    <a href="<?php echo e(route('login')); ?>"
       class="inline-flex items-center gap-2 text-sm text-blue-600 hover:underline hover:text-blue-800 transition">
        ...
        <p class="mt-6 text-sm text-center text-gray-600">
            Sudah punya akun?
            <a href="<?php echo e(route('login')); ?>" class="text-blue-600 font-semibold hover:underline">Masuk di sini</a>
        </p>
    </div>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\THRIFT_STORE_LITTLE_SCNDH2\resources\views/auth/register.blade.php ENDPATH**/ ?>