...
<body class="bg-gradient-to-r from-blue-100 to-blue-200 min-h-screen flex items-center justify-center px-4">
    ...
    <img src="<?php echo e(asset('storage/products/Logo.png')); ?>" 
    ...
    <p class="text-sm text-gray-500">Masuk untuk mulai berbelanja!</p>
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 hover:underline">Lupa Password?</a>
            </div>
...
<?php /**PATH C:\xampp\htdocs\THRIFT_STORE_LITTLE_SCNDH2\resources\views/auth/login.blade.php ENDPATH**/ ?>